...
WALLET = "0x39ba1cef36785ecb3a9f92a3278e0b78c23b8b32"
AGENT = "varizgam"
    ...
    try:
        response = groq_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You solve cryptographic and logic puzzles. Return ONLY the final answer without explanation."
                },
                {
                    "role": "user",
                    "content": prompt
...
def solve_puzzle(puzzle):
    ...
    # POST QUANTUM
    elif "post-quantum signature scheme" in prompt_lower:
        answer = "crystals-dilithium"
